...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CY9baN5u.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BIRTkevo.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "mulier-cafe-landing";
var SERVER_FN_BASE = "/mulier-cafe-landing/_serverFn/";
